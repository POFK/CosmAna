...
def forwardF(MPI.Comm comm not None, i_arr):
    """
    ...
    cpyfftw.FPyFFTW_FORWARD(c_comm, 
                           N, 
                           &c_irarr[0], 
                           &c_iiarr[0], 
                           &c_orarr[0], 
...
@cython.boundscheck(False)
@cython.wraparound(False)
def backwardF(MPI.Comm comm not None, i_arr):
    """
    i_arr: 3-D input array, complex64
    """
    cdef MPI_Comm c_comm = comm.ob_mpi
    ...
    cpyfftw.FPyFFTW_BACKWARD(c_comm, 
                           N, 
                           &c_irarr[0], 
                           &c_iiarr[0], 
                           &c_orarr[0], 
...
@cython.boundscheck(False)
@cython.wraparound(False)
def forwardD(MPI.Comm comm not None, i_arr):
    """
    i_arr: 3-D input array, complex128
    """
    cdef MPI_Comm c_comm = comm.ob_mpi
    cdef int size, rank, N
    MPI_Comm_size(c_comm, &size)
    ...
    cdef double[::1] c_irarr = irarr
    cdef double[::1] c_iiarr = iiarr
    cdef double[::1] c_orarr = orarr
    cdef double[::1] c_oiarr = oiarr

    cpyfftw.DPyFFTW_FORWARD(c_comm, 
                           N, 
                           &c_irarr[0], 
                           &c_iiarr[0], 
                           &c_orarr[0], 
...
@cython.boundscheck(False)
@cython.wraparound(False)
def backwardD(MPI.Comm comm not None, i_arr):
    """
    i_arr: 3-D input array, complex128
    """
    cdef MPI_Comm c_comm = comm.ob_mpi
    ...
    cpyfftw.DPyFFTW_BACKWARD(c_comm, 
                           N, 
                           &c_irarr[0], 
                           &c_iiarr[0], 
                           &c_orarr[0], 
